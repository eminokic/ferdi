...
export declare const DEFAULT_ACCENT_COLOR = "#7266F0";
export declare function theme(themeId: ThemeType, brandColor?: string): {
    brandPrimary: string;
    brandSuccess: string;
    brandInfo: string;
    brandWarning: string;
    ...
    toggleWidth: number;
    toggleHeight: number;
    styleTypes: import("./themes/IStyleTypes").IStyleTypes;
    ...
    legacyStyles: typeof import("./themes/legacy");
};
declare const defaultThemeConfigWithDefaultAccentColor: {
    brandPrimary: string;
    brandSuccess: string;
    brandInfo: string;
    brandWarning: string;
...
export declare type Theme = typeof defaultThemeConfigWithDefaultAccentColor;
export {};
